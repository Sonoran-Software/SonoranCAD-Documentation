...
* [🎮 FiveM](integration-plugins/in-game-integration/README.md)
  * [FiveM Installation](integration-plugins/in-game-integration/fivem-installation/README.md)
    ...
    * [FiveM Submodules](integration-plugins/in-game-integration/fivem-installation/available-plugins/README.md)
      ...
      * [Local Callers](integration-plugins/in-game-integration/fivem-installation/available-plugins/locations.md)
      * [Locations](integration-plugins/in-game-integration/fivem-installation/available-plugins/locations-1.md)
...
* [📖 API Integration](sonoran-cad/api-integration/README.md)
  ...
  * [Push Events](sonoran-cad/api-integration/push-events/README.md)
    ...
    * [Unit Events](sonoran-cad/api-integration/push-events/unit-events/README.md)
      * [Unit Panic](sonoran-cad/api-integration/push-events/unit-events/unit-panic.md)
    ...
    * [ERS](sonoran-cad/api-integration/push-events/ers/README.md)
      * [New Callout](sonoran-cad/api-integration/push-events/ers/new-callout.md)
    * [Station Alert](sonoran-cad/api-integration/push-events/station-alert/README.md)
      * [New Station Alert](sonoran-cad/api-integration/push-events/station-alert/new-station-alert.md)
  * [API Endpoints](sonoran-cad/api-integration/api-endpoints/README.md)
    ...
    * [Emergency](sonoran-cad/api-integration/api-endpoints/emergency/README.md)
      * [Identifiers](sonoran-cad/api-integration/api-endpoints/emergency/identifiers/README.md)
        * [Get Identifiers](sonoran-cad/api-integration/api-endpoints/emergency/identifiers/get-identifiers.md)
        * [Modify Identifier](sonoran-cad/api-integration/api-endpoints/emergency/identifiers/modify-identifier.md)
        * [Set Identifier](sonoran-cad/api-integration/api-endpoints/emergency/identifiers/set-identifier.md)
        * [Unit Panic](sonoran-cad/api-integration/api-endpoints/emergency/identifiers/unit-panic.md)
        * [Kick Unit](sonoran-cad/api-integration/api-endpoints/emergency/identifiers/kick-unit.md)
        * [Unit Status](sonoran-cad/api-integration/api-endpoints/emergency/identifiers/unit-status.md)
        * [Get Active Units](sonoran-cad/api-integration/api-endpoints/emergency/identifiers/get-active-units.md)
        * [Update Unit Location](sonoran-cad/api-integration/api-endpoints/emergency/identifiers/update-unit-location.md)
      * [Dispatch and Emergency Calls](sonoran-cad/api-integration/api-endpoints/emergency/dispatch-and-emergency-calls/README.md)
        * [Get Calls](sonoran-cad/api-integration/api-endpoints/emergency/dispatch-and-emergency-calls/get-calls.md)
        * [New Dispatch](sonoran-cad/api-integration/api-endpoints/emergency/dispatch-and-emergency-calls/new-dispatch.md)
        * [Attach Unit](sonoran-cad/api-integration/api-endpoints/emergency/dispatch-and-emergency-calls/attach-units.md)
        * [Detach Unit](sonoran-cad/api-integration/api-endpoints/emergency/dispatch-and-emergency-calls/detach-unit.md)
        * [Update Call Postal](sonoran-cad/api-integration/api-endpoints/emergency/dispatch-and-emergency-calls/update-call-postal.md)
        * [Add Call Note](sonoran-cad/api-integration/api-endpoints/emergency/dispatch-and-emergency-calls/add-call-note.md)
        * [Update Call Primary](sonoran-cad/api-integration/api-endpoints/emergency/dispatch-and-emergency-calls/update-call-primary.md)
        * [Close Dispatch](sonoran-cad/api-integration/api-endpoints/emergency/dispatch-and-emergency-calls/close-call.md)
        * [New 911 Call](sonoran-cad/api-integration/api-endpoints/emergency/dispatch-and-emergency-calls/911-call.md)
        * [Remove 911](sonoran-cad/api-integration/api-endpoints/emergency/dispatch-and-emergency-calls/remove-911.md)
      * [Custom Blips](sonoran-cad/api-integration/api-endpoints/emergency/custom-blips/README.md)
        * [Get Map Blips](sonoran-cad/api-integration/api-endpoints/emergency/custom-blips/get-map-blips.md)
        * [Add Blip](sonoran-cad/api-integration/api-endpoints/emergency/custom-blips/add-blip.md)
        * [Modify Blip](sonoran-cad/api-integration/api-endpoints/emergency/custom-blips/modify-blip.md)
        * [Remove Blip](sonoran-cad/api-integration/api-endpoints/emergency/custom-blips/remove-blip.md)
      * [Street Signs](sonoran-cad/api-integration/api-endpoints/emergency/street-signs/README.md)
      ...
      * [ERS](sonoran-cad/api-integration/api-endpoints/emergency/ers/README.md)
        * [Set Available Callouts](sonoran-cad/api-integration/api-endpoints/emergency/ers/set-street-sign-config.md)
      * [Station Alert](sonoran-cad/api-integration/api-endpoints/emergency/station-alert/README.md)
        * [Set Stations](sonoran-cad/api-integration/api-endpoints/emergency/station-alert/set-stations.md)
    * [Civilian](sonoran-cad/api-integration/api-endpoints/civilian/README.md)
      ...
      * [DB Sync: Get Character Links](sonoran-cad/api-integration/api-endpoints/civilian/db-sync-get-character-links.md)
      * [DB Sync: Link Character](sonoran-cad/api-integration/api-endpoints/civilian/db-sync-link-character.md)
  ...
  * [API Examples](sonoran-cad/api-integration/api-examples/README.md)
    * [Emergency](sonoran-cad/api-integration/api-examples/emergency/README.md)
      * [LUA Examples](sonoran-cad/api-integration/api-examples/emergency/lua-examples/README.md)
        * [Dispatch and Emergency Calls](sonoran-cad/api-integration/api-examples/emergency/lua-examples/dispatch-and-emergency-calls/README.md)
          * [New 911 Call](sonoran-cad/api-integration/api-examples/emergency/lua-examples/dispatch-and-emergency-calls/new-911-call.md)
          * [Remove 911](sonoran-cad/api-integration/api-examples/emergency/lua-examples/dispatch-and-emergency-calls/remove-911.md)
          * [Add Call Note](sonoran-cad/api-integration/api-examples/emergency/lua-examples/dispatch-and-emergency-calls/add-call-note.md)
          * [Set Call Postal](sonoran-cad/api-integration/api-examples/emergency/lua-examples/dispatch-and-emergency-calls/add-call-note-1.md)
        * [Custom Blips](sonoran-cad/api-integration/api-examples/emergency/lua-examples/custom-blips/README.md)
          * [Add Blip](sonoran-cad/api-integration/api-examples/emergency/lua-examples/custom-blips/add-blip.md)
          * [Add Blips](sonoran-cad/api-integration/api-examples/emergency/lua-examples/custom-blips/add-blip-1.md)
          * [Add Temp Blip](sonoran-cad/api-integration/api-examples/emergency/lua-examples/custom-blips/add-blip-2.md)
          * [Get Map Blips](sonoran-cad/api-integration/api-examples/emergency/lua-examples/custom-blips/get-map-blips.md)
          * [Remove Blip](sonoran-cad/api-integration/api-examples/emergency/lua-examples/custom-blips/remove-blip.md)
          * [Remove Blip With Subtype](sonoran-cad/api-integration/api-examples/emergency/lua-examples/custom-blips/get-map-blips-1.md)
        * [General](sonoran-cad/api-integration/api-examples/emergency/lua-examples/general/README.md)
          * [Lookup Name or Plate](sonoran-cad/api-integration/api-examples/emergency/lua-examples/general/lookup-name-or-plate.md)
      * [JavaScript Examples](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/README.md)
        * [Dispatch and Emergency Calls](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/dispatch-and-emergency-calls/README.md)
          * [New 911 Call](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/dispatch-and-emergency-calls/new-911-call.md)
          * [Remove 911](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/dispatch-and-emergency-calls/remove-911.md)
          * [Add Call Note](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/dispatch-and-emergency-calls/add-call-note.md)
          * [Set Call Postal](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/dispatch-and-emergency-calls/add-call-note-1.md)
        * [Custom Blips](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/custom-blips/README.md)
          * [Add Blip](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/custom-blips/add-blip.md)
          * [Add Blips](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/custom-blips/add-blip-1.md)
          * [Add Temp Blip](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/custom-blips/add-blip-2.md)
          * [Get Map Blips](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/custom-blips/get-map-blips.md)
          * [Remove Blip](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/custom-blips/remove-blip.md)
          * [Remove Blip With Subtype](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/custom-blips/get-map-blips-1.md)
        * [General](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/general/README.md)
          * [Lookup Name or Plate](sonoran-cad/api-integration/api-examples/emergency/javascript-examples/general/lookup-name-or-plate.md)
