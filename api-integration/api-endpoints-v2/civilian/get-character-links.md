---
description: Retrieve linked sync-character IDs for a community user, linked Roblox user, or account.
---
...
Retrieve linked sync-character IDs for a community user, linked Roblox user, or account.
