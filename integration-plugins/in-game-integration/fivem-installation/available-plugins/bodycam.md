...
| ------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `command`                       | <p>The command name to toggle your body camera on or off.<br>Default: <code>bodycam</code></p>                                                                                                                                          |
| `enableAnimation`               | <p>Enables or disables animations on start up. Players can still toggle animations with <code>/bodycam anim</code></p>                                                                                                                  |
| `enableBeeps`                   | <p>Enables or disables the body camera beeping when turned on.<br>Default: <code>true</code></p>                                                                                                                                        |
| `beepType`                      | <p>Type of audio that the beeps use. Can be <code>native</code>/<code>nui</code>.</p>                                                                                                                                                   |
...
| `beepRange`                     | <p>Adjusts the range at which a person can hear the bodycam beeps<br>Default: <code>19.99</code></p>                                                                                                                                    |
