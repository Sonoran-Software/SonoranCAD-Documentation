...
Click [HERE ](https://github.com/Sonoran-Software/sonoran\_livemap/releases)to download the live map plugin .zip file.
...
![Sonoran CAD - Live Map Admin Panel Config](<../../../../.gitbook/assets/image (207).png>)
